...
function getAnswer(text: string): string {
  ...
  if (lower.includes('привет') || lower.includes('здравствуй') || lower.includes('добрый')) {
    return 'Привет, Артур! 👋 Я ваш персональный финансовый помощник ГПБ. Могу помочь с вопросами о зарплате, налогах, кэшбэке и картах. Что вас интересует?';
  }
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 0,
      role: 'assistant',
      text: 'Привет, Артур! Я ваш персональный финансовый помощник ГПБ. Помогу разобраться с зарплатой, налогами, кэшбэком и любыми вопросами по банку.',
      time: formatTime(),
    },
  ]);
